...
from product.views import category_list_api_view, category_detail_api_view , product_detail_api_view, product_list_api_view, review_detail_api_view,review_list_api_view
